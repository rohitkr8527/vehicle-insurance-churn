...
class ModelTrainerConfig:
    ...
    _border_count: int = MODEL_TRAINER_BORDER_COUNT
    _bagging_temperature: int = MODEL_TRAINER_BAGGING_TEMPERATURE
    _random_strength: int = MODEL_TRAINER_RANDOM_STRENGTH

    # Business-specific threshold
    _optimal_threshold: float = MODEL_TRAINER_OPTIMAL_THRESHOLD
